...
namespace TimeSheet.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(string id, string email, string FirstName, string LastName, decimal hourlyWage, bool exceptFromOverTime, string password)
        {
            ApplicationUser user = await _userManager.FindByIdAsync(id);
            ...
            if(user != null)
            {
                ...
                user.ExceptFromOvertime = exceptFromOverTime;
